...
def train_model(model_name_key: str, model_name: str, num_classes: int, 
    ...
    scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.1, patience=3, erbose=True)
    ...
    for epoch in range(config.EPOCHS):
        ...
        scheduler.step(val_loss) # Beri tahu scheduler nilai val_loss terbaru
        # Simpan metrics
